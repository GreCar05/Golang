...
var AuthenticatedUser models.UserModel

// GetUserByToken returns a User by token
func GetUserByToken(tokenString string) (models.UserModel, error) {
...
func GetUserFromRequest(request *http.Request) (models.UserModel, error) {
